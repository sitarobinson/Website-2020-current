...
const TravelMap = lazy(
  () => import("../components/reusable-components/travel-map"),
);
...
export const welcomeContent = [
  {
    ...
    textcontent: (
      <WhiteCard>
        <p>
          I'm a Lead Software Engineer who has spent six years building web
          applications end to end, from React frontends to the APIs behind them.
          For the past four years I've been at Booz Allen Hamilton working on
          Recreation.gov, the platform people use to discover and book
          campsites, permits, and tours across national parks and federal lands.
          Before that, I spent two years at Vanguard building the Java and
          Spring APIs supporting their investment platform.
        </p>
        <p>
          I hold a BS in Data Science with a CS minor from Drexel University and
          an MBA from the University of Maryland.
        </p>
        <p>
          Outside of work, my hobbies include building side projects, crochet
          (amigurumi), landscape photography, quilting, playing Scrabble and
          traveling around the world. I am a Northern Virginia/Metro D.C.
          native.
        </p>
        <p>
          Currently interested in opportunities in frontend development or
          fullstack roles with a frontend tilt. Open to relocating.
        </p>
      </WhiteCard>
    ),
  },
        ...
        <div className="row">
          <SkillsCard
            ...
            groups={[
              {
                label: "Deploy",
                skills: "Jenkins, ArgoCD, Github Actions, Bamboo",
              },
